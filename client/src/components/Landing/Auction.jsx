    ...
    <section className="py-20 sm:py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-end justify-between mb-10">
          <div>
            <p className="text-gray-600 font-semibold text-sm uppercase tracking-wider mb-2">
              Trending
            </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {auctions.map((item) => (
            ...
            >
              ...
              <div className="p-4">
                <h3 className="font-semibold text-sm text-gray-900 mb-3 line-clamp-1 group-hover:text-black transition-colors">
                  {item.title}
                </h3>
