...
export const Hero = () => {
  return (
    <section className="relative overflow-hidden">
      {/* Gradient background */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-black-50/40" />
      <div className="absolute top-20 left-10 w-72 h-72 bg-gray-100/40 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-6xl mx-auto px-4 pt-20 pb-24 sm:pt-28 sm:pb-32">
        <div className="text-center max-w-3xl mx-auto">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-gray-200 border border-gray-400 text-black text-xs font-semibold px-4 py-1.5 rounded-full mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/signup"
              className="inline-flex items-center justify-center bg-gray-600 text-white px-8 py-3.5 rounded-xl hover:bg-black active:scale-[0.97] transition-all font-semibold text-base shadow-sm shadow-gray-200"
            >
              Get Started Free
              <svg
