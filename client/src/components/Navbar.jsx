          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex justify-between items-center h-16">
              ...
              <Link to="/" className="flex items-center gap-2.5 group">
                <div className="bg-black text-white p-1.5 rounded-lg group-hover:bg-gray-500 transition">
        ...
        >
          ...
          {user ? (
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 space-y-2 px-1">
              ...
              <Link
                to="/signup"
                className="block w-full py-2.5 px-4 text-center bg-gray-600 text-white rounded-xl text-sm font-medium hover:bg-black transition"
                onClick={() => setIsMenuOpen(false)}
              >
                Sign up
              </Link>
...
export const LoginSignup = () => {
  return (
    <>
      ...
      <Link
        to="/signup"
        className="px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-xl hover:bg-black transition"
      >
        Sign up
      </Link>
    </>
