    ...
    >
      ...
      <div className="relative aspect-[3/2] overflow-hidden rounded-t-2xl bg-gray-100">
        ...
        <div className="absolute top-3 left-3 flex items-center gap-2">
          <span className="text-[11px] font-medium text-gray-700 bg-white/90 backdrop-blur-sm px-2.5 py-1 rounded-full shadow-sm">
      ...
      {/* Content */}
      <div className="p-3.5">
        <h3 className="font-semibold text-sm text-gray-800 mb-0.5 line-clamp-1 group-hover:text-black transition-colors">
          {auction.itemName}
        </h3>
