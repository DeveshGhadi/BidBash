...
export const CreateAuction = () => {
  ...
  const inputClasses =
    "w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 text-sm placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-700/40 focus:border-black transition";
                ...
                <button
                  ...
                  className={`w-full sm:w-auto px-8 py-3 rounded-xl font-semibold text-sm transition-all ${
                    submitDisabled
                      ...
                      : "bg-gray-600 text-white hover:bg-black active:scale-[0.97] shadow-sm shadow-gray-200"
                  }`}
                >
                  {isUploading
                    ? "Uploading..."
