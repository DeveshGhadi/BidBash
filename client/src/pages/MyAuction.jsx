    ...
    <div className="min-h-screen bg-gray-50/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            to="/create"
            className="inline-flex items-center gap-2 bg-gray-700 text-white text-sm font-semibold px-5 py-2.5 rounded-xl hover:bg-black active:scale-[0.97] transition-all shadow-sm shadow-gray-200"
          >
            <svg
              className="w-4 h-4"
              fill="none"
