      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="bg-white rounded-sm shadow-sm p-8">
          ...
          <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
            <p className="text-lg">
              Welcome to BidBash - Online Auction System - a comprehensive web
            ...
            <section>
              ...
              <p>
                This project has been created by <strong>Devesh Ghadigaonkar & Aditya Bhangare</strong>{" "}
                as a demonstration of modern web development techniques.
              </p>
