            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-800">
                  {bid.bidder?.name}
                  {index === 0 && (
                    <span className="ml-2 text-[10px] font-semibold uppercase text-gray-600 bg-gray-100 px-1.5 py-0.5 rounded">
                      Leading
                    </span>
                  )}
                </p>
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <span className="text-xs font-medium text-black bg-gray-200 px-2.5 py-1 rounded-full">
                  {data.itemCategory}
                </span>
              </div>
